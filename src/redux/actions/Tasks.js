import {
  ...
  POST_FILTERED_TASKS, REFRESH_STATUS_TASK
...
export const postFilteredTasks = tasks => {
  return {
    type: POST_FILTERED_TASKS,
    payload: tasks
  };
}

export const refreshStatusTask = task => {
  return {
    type: REFRESH_STATUS_TASK,
    payload: task
  }
}