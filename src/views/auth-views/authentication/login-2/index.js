					...
					<div className="container d-flex flex-column justify-content-center h-100">
						<Row justify="center">
							<Col xs={24} sm={24} md={20} lg={12} xl={8}>
								...
								{/*<p>Aun no tienes cuenta? <a href="/auth/register-2">Registrate</a></p>*/}
								<div className="mt-4">
									<LoginForm {...props}/>
								</div>
							</Col>
					...
					<div className="d-flex flex-column justify-content-between h-100 px-4" style={backgroundStyle}>
						...
						<Row justify="center">
							<Col xs={0} sm={0} md={0} lg={20}>
								...
								<h1 className="text-white">Task App</h1>
						...
						<div className="d-flex justify-content-end pb-4">
							<div>
								<a className="text-white" href="/#" onClick={e => e.preventDefault()}>Terminos y Condiciones</a>
								<span className="mx-2 text-white"> | </span>
								<a className="text-white" href="/#" onClick={e => e.preventDefault()}>Politica de Privacidad</a>
							</div>
						</div>
					</div>
				</Col>
